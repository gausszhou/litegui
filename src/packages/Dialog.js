...
Dialog.prototype._ctor = function (options) {
	...
	this.root.addEventListener("DOMNodeRemovedFromDocument", function () {
		if (that.on_detached_from_DOM) that.on_detached_from_DOM();
	});
...
Dialog.prototype.close = function () {
	...
	if (this.onclose) console.warn("Dialog: Do not use onclose, use on_close instead");
